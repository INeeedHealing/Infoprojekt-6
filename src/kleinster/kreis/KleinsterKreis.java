...
public class KleinsterKreis {
    ...
    public static int rundenNummer = 0;
    final static int MAXANZAHLP = 1000;
    public static int anzahlP;
    final static int ZULOSENDEP = 13;
    final static int DURCHLÄUFE = 5;
    public static double zeiten[] = new double[DURCHLÄUFE * MAXANZAHLP];
    public static double gebrauchteZeit;
    public static int[] ausgelosteP = new int[ZULOSENDEP]; //Index in points
    public static Tuple[] points;       //Koordinaten
    ...
    public static long wartezeit = 0;
    ...
    public static void main(String[] args) {
        ...
        ZeitOutput zt = new ZeitOutput();
        zt.setVisible(true);

        for (int d = 13; d <= MAXANZAHLP; d++) {
            points = new Tuple[d];
            anzahlP = d;
            ...
            rundenNummer = d - 13;
            zeiten[rundenNummer] = gebrauchteZeit;
            System.out.println("Kreis passt um alle");
            System.out.println("Gebrauchte Zeit: " + gebrauchteZeit + "s");
            zt.refresh();
        }
    }
}
